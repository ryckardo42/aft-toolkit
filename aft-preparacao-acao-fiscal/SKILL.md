...
description: >
  ...
  /aft-inspecao-fisica. Resolve/cria a OS (via /aft-nova-os), coleta os insumos
  ...
  encadeia a /aft-NAD. Salva tudo em preparacao.md na pasta da OS. NÃO redige
  auto nem faz o relato de campo (isso é /aft-inspecao-fisica →
  /aft-auditoria-geral, depois da visita).
---
