...
- **Para quem tem o Gmail autorizado no notebooks-aft** (o mesmo acesso dos
  NotebookLMs): o `/aft-setup` (Passo 2a) conecta a sua conta Google uma única
  vez — abre o navegador, você escolhe a conta e clica em Permitir — e baixa as
  planilhas de CAT **só da sua UF** direto para `Documentos\AFT\CATs`. Nada de
  procurar pasta no SharePoint.
