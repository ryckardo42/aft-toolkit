...
> Para efetivamente lavrar, encaminhe ao `/aft-auditoria-geral` (que redige o auto) e ao `/aft-gera-ai`
...
> `/aft-auditoria-geral` (redige o auto completo) e depois ao `/aft-gera-ai` (empacota o TXT). O
> Subtítulo 3 (OBSERVAÇÕES) é fixo e injetado pelo `/aft-gera-ai` — não o inclua aqui.
