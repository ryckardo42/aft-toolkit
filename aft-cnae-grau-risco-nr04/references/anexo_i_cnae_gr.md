# NR-04 — Anexo I — Relação CNAE 2.0 com o correspondente Grau de Risco (GR)
## Tabela integral de enquadramento das atividades econômicas nos graus de risco 1 a 4 para dimensionamento do SESMT

| Campo | Informação |
|---|---|
| Tipo normativo | Anexo de Norma Regulamentadora |
| Norma | **NR-04** — Serviços Especializados em Segurança e em Medicina do Trabalho |
| Denominação oficial | Anexo I — Relação da Classificação Nacional de Atividades Econômicas - CNAE (Versão 2.0), com correspondente Grau de Risco - GR |
| Órgão emissor | Ministério do Trabalho e Previdência |
| Redação atual dada por | Portaria MTP nº 2.318, de 03 de agosto de 2022 (DOU 12/08/2022) |
| Alteração pontual registrada | Portaria SIT nº 128, de 11 de dezembro de 2009 — grau de risco do CNAE 23.42-7 |
| Tema / Assunto | Enquadramento de atividade econômica em **grau de risco (GR)** para dimensionamento do SESMT |
| Remissão de fonte | Informações sobre detalhamentos dos CNAE ver https://cnae.ibge.gov.br/ |

## Contexto e Finalidade

O **Anexo I da NR-04** relaciona cada código da **CNAE 2.0** ao respectivo **grau de risco (GR)**, em escala de 1 a 4. Esse grau é o primeiro dos dois parâmetros de dimensionamento do **SESMT** — o segundo é o número de trabalhadores no estabelecimento, conforme o **Anexo II**. Nos termos do item 4.5.1 da NR-04, aplica-se o **maior grau de risco** entre a atividade econômica principal (constante do CNPJ) e a atividade econômica preponderante (a que ocupa o maior número de trabalhadores) no estabelecimento. Na ação fiscal, este anexo é a fonte para conferir o enquadramento declarado pela organização e apurar subdimensionamento do serviço.
...
> [⚠️ Texto-fonte incompleto neste ponto: o documento consultado passa diretamente do código 20.99-1 para o 21.10-6, sem reproduzir o título da divisão 21 nem o do grupo 21.1. Os títulos aqui indicados são inferidos apenas para fins de hierarquia do documento e devem ser conferidos no texto oficial publicado no DOU.]
...
| 23.42-7 | Fabricação de produtos cerâmicos não-refratários para uso estrutural na construção *(grau de risco alterado pela Portaria SIT nº 128, de 11 de dezembro de 2009)* | 3 |
...
### Divisão 37 — Esgoto e atividades relacionadas
...
### Divisão 39 — Descontaminação e outros serviços de gestão de resíduos
...
### Divisão 77 — Aluguéis não-imobiliários e gestão de ativos intangíveis não-financeiros
...
### Divisão 88 — Serviços de assistência social sem alojamento
...
> **Nota de rodapé do Anexo I:** Informações sobre detalhamentos dos CNAE ver https://cnae.ibge.gov.br/

---

## Distinções e Correlações

| Elemento | Função na NR-04 | Onde está |
|---|---|---|
| **Anexo I** | Define o **grau de risco (GR)** de cada CNAE 2.0 | Este documento |
| **Anexo II** | Define o **número mínimo de profissionais** do SESMT por GR e faixa de trabalhadores | Documento `nr04_sesmt_corpo_normativo.md` |
| Item 4.5.1 | Determina que se aplique o **maior GR** entre atividade principal (CNPJ) e preponderante (maior número de trabalhadores) | Corpo da NR-04 |
| Item 4.5.3.1 | Para estabelecimentos de **GR 1 e 2** de **ME** e **EPP**, considera-se o somatório da **metade** do número de trabalhadores | Corpo da NR-04 |

**Atenção ao uso do Anexo I:** o grau de risco desta tabela é o da **NR-04**, destinado ao dimensionamento do SESMT. Não se confunde com o grau de risco ou alíquota de contribuição para financiamento de benefícios acidentários (RAT/FAP), que possui base normativa própria e não é objeto desta NR.
...
|---|---|---|
| **NR-04** | Anexo I | Relação CNAE 2.0 × grau de risco |
| **NR-04** | Item 4.5.1 e subitens | Vinculação do dimensionamento ao GR e ao número de empregados; atividade principal e preponderante |
| **NR-04** | Anexo II | Dimensionamento do SESMT por GR e faixa de trabalhadores |
| Portaria MTP nº 2.318, de 03/08/2022 | — | Redação vigente da NR-04 e de seus anexos |
| Portaria SIT nº 128, de 11/12/2009 | — | Alteração do grau de risco do CNAE 23.42-7 |
| CNAE 2.0 (IBGE) | — | Classificação Nacional de Atividades Econômicas, versão 2.0 |
