...
```bash
python ~/.claude/skills/aft-jornada-atestado/scripts/inspecionar_assinatura.py "/caminho/para/o/atestado.pdf"
```
...
## Bloco para o /aft-gera-ai (autuação — quando NÃO CONFORME)

Quando a conclusão for **NÃO CONFORME** e o AFT quiser autuar, além do parecer
emita o bloco abaixo, **pronto para o /aft-gera-ai** (mesmo formato de det-630 e
...
> **Não escreva o rótulo `III - OBSERVAÇÕES`.** O parágrafo sobre a frustração da conformidade do sistema de ponto (acima) fica como parágrafo final do Subtítulo 2. O Subtítulo 3 canônico é injetado automaticamente pelo `/aft-gera-ai` (de `config/blocos_auto.md`) entre o bloco 2 e os ELEMENTOS DE CONVICÇÃO.
...
Após emitir o bloco, faça o handoff: o texto alimenta o **/aft-gera-ai** (modo "autos
